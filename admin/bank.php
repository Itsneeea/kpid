                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="periode" required="required" class="form-control" placeholder="Nama Akun ..">
                                            </div>

                                            <div class="form-group">
                                                <label>Periode</label>
                                                <input type="text" name="pemilik" class="form-control" placeholder="Periode Akun ..">
                                            </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group" style="margin-bottom:15px;width: 100%">
                                                                        ...
                                                                        <input type="text" name="periode" style="width:100%" required="required" class="form-control" placeholder="Nama bank .." value="<?php echo $d['periode']; ?>">
                                                                    </div>
