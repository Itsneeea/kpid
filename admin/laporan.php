                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        ?>
                            ...
                            <a href="laporan_excel.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kategori=<?php echo $kategori ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK
                                EXCEL</a>
