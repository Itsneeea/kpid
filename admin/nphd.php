                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_nphd" class="form-control" id="kategori" onchange="showUraian()">
                                    <option value="">
                                        -Pilih-
                                    </option>
                                    <?php
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group" style="width:100%;margin-bottom:20px">
                                        <label>Kategori</label>
                                        <select name="uraian_nphd" class="form-control" id="kategori">
                                            <option value="">
                                                -Pilih-
                                            </option>
                                            <?php
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="nphd_hapus.php?id=<?php echo $d['id_nphd'] ?>" class="btn btn-primary">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
